...
export const addEffectValue = (styleMap: StylAbleZMap, fileName: string, token: string, tokenKey: string, tokenValue: string) => {
...
export const addBlendMode = (styleMap: StylAbleZMap, fileName: string, token: string, tokenKey: string, tokenValue: string) => {
